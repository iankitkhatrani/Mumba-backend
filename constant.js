const CONST = {
  ...
  ANADAR_BAHAR_ROUND_START_TIMER: 'ABRST',
  ANADAR_BAHAR_GAME_TABLE_INFO: 'ABGTI',
  START_ANADAR_BAHAR_BATTING: "SBAT",
  ANADAR_BAHAR_BATTING_STOP: "ABBS",
  ANADAR_BAHAR_LOGIC: "Client",
  ACTION_ANADAR_BAHAR: "ABAction",
  ANADAR_BAHAR_GAME_START_TIMER: 'ABGST',
  ANADAR_BAHAR_SHOW_DECLARE_CARD: 'ABSDC',
  ANDER_BAHAR_SHOW_CARDS: 'ABSC',
  ANADAR_BAHAR_CLEAR_BET: 'ABCB',
  ANADAR_BAHAR_DOUBLE_BET: 'ABDB',
  ANADAR_BAHAR_RECONNECT: 'ANB_RECONNECT',
